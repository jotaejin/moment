...
export default function SignInPage(){
    ...
    const handleSignWithPasswordClick = () =>{
    ...
    return <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
            ...
            className="py-6" type="email" placeholder="example@abc.com"/>
            <Input 
            disabled={isPending}
            value={password}
        ...
        <div className="flex flex-col gap-2">
            <Button 
            disabled={isPending}
            onClick={handleSignWithPasswordClick}className="w-full">
                로그인
            </Button>
            <Button
            disabled={isPending}
            onClick={handleSignWithGitHubClick} className="w-full" variant={'outline'}>
